package com.xayn.adblocker.webviewadblocker
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (BuildConfig.DEBUG && !match.isMatched) {
            error("Assertion failed")
        }
        if (BuildConfig.DEBUG && match.isImportant) {
            error("Assertion failed")
        }
        if (BuildConfig.DEBUG && match.isException) {
            error("Assertion failed")
        }
